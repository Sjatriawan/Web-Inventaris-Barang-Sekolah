    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center bg-primary justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3">SMAN 1 PRINGGABAYA</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link pb-0" href="<?= base_url('supplier'); ?>">
                    ...
                    <span>Tim Pengadaan</span>
                </a>
            </li>

             <li class="nav-item">
                <a class="nav-link pb-0" href="<?= base_url('pemeriksa'); ?>">
                    <i class="fas fa-fw fa-users"></i>
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Inventory Barang SMAN 1 Pringgabaya</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
