            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-md-5">
                        <div class="input-group">
                            <input value="<?= set_value('ket'); ?>" name="ket" id="ket" class="form-control" placeholder="Keterangan...">
                        </div>
                  ...
                  <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="ket">Pemakai</label>
                    <div class="col-md-5">
                        <div class="input-group">
                            <input value="<?= set_value('pemakai'); ?>" name="pemakai" id="pemakai" class="form-control" placeholder="Pemakai...">
                        </div>
                        <?= form_error('pemakai_barang', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div>
